...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        ic.añadirUsuario("kairoh", "Kairo", "Herrera", "kairoher@pilsenrock.com.uy", LocalDate.of(1970, 4, 25), "KH.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()), "Paraguay 1423", "", "");
        ic.añadirUsuario("losBardo", "Los", "Bardo", "losbardo@bardocientifico.com", LocalDate.of(1980, 10, 31),  "LB.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()), "8 de Octubre 1429", "Queremos ser vistos y reconocidos como una organización: referente en divulgación científica con un fuerte espíritu didáctico y divertido, a través de acciones coordinadas con otros divulgadores científicos, que permitan establecer puentes de comunicación. Impulsora en la generación de espacios de democratización y apropiación social del conocimiento científico.", "https://bardocientifico.com/");

        //COLABORADORES
        ic.añadirUsuario("robinh", "Robin", "Henderson", "Robin.h@tinglesa.com.uy", LocalDate.of(1940, 8, 3), "", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("marcelot", "Marcelo", "Tinelli", "marcelot@ideasdelsur.com.ar", LocalDate.of(1960, 4, 1), "MT.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("novick", "Edgardo", "Novick", "edgardo@novick.com.uy", LocalDate.of(1952, 7, 17), "EN.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("sergiop", "Sergio", "Puglia", "puglia@alpanpan.com.uy", LocalDate.of(1950, 1, 28),  "SP.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("chino", "Alvaro", "Recoba", "chino@trico.org.uy", LocalDate.of(1976, 3, 17), "AR.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("tonyp", "Antonio", "Pacheco", "eltony@manya.org.uy", LocalDate.of(1955, 2, 14), "", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ic.añadirUsuario("nicoJ", "Nicolás", "Jodal", "jodal@artech.com.uy", LocalDate.of(1960, 8, 9),  "NJ.jpg", BCrypt.hashpw("1234", BCrypt.gensalt()));
        ...
        ic.altaPropuesta("hrubino", "Parodistas", "Religiosamente",
                ...
                "Teatro de Verano", LocalDate.of(2025, 10, 7), "300", "300000", EnumRetorno.AMBOS, LocalDate.of(2025, 6, 18), "MOM.jpg");
        ...
        ic.altaPropuesta("mbusca", "Concierto", "El Pimiento Indomable",
                ...
                "Teatro Solís", LocalDate.of(2025, 10, 19), "400", "400000", EnumRetorno.PORCENTAJE_VENTAS, LocalDate.of(2025, 7, 26), "PIM.jpg");
        ...
        ic.altaPropuesta("kairoh", "Festival", "Pilsen Rock",
                ...
                "Rural de Prado", LocalDate.of(2025, 10, 21), "1000", "900000", EnumRetorno.AMBOS, LocalDate.of(2025, 7, 30), "PIL.jpg");
        ...
        ic.altaPropuesta("juliob", "Ballet", "Romeo y Julieta",
                ...
                "Auditorio Nacional del Sodre", LocalDate.of(2025, 11, 5), "800", "750000", EnumRetorno.PORCENTAJE_VENTAS, LocalDate.of(2025, 8, 4), "RYJ.jpg");
        ...
        ic.altaPropuesta("tabarec", "Murga", "Un día de Julio",
                ...
                "Landia", LocalDate.of(2025, 11, 16), "650", "300000", EnumRetorno.AMBOS, LocalDate.of(2025, 8, 6), "UDJ.jpg");
