...
public class InterConsultaProponenteEliminado extends javax.swing.JInternalFrame {
    private final IControlador ic;
    private List<String> listaProponentes; //Solo tiene los NickNames de los Proponentes Eliminados para llenar el comboBox
    ...
    public InterConsultaProponenteEliminado(IControlador ic) {
        this.setTitle("Consulta Proponente Eliminado");
        this.ic = ic;
        listaProponentes = ic.getUsuariosProponentesEliminados();
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione el Proponente Eliminado a consultar:");
